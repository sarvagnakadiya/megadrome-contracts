...
contract ManagedNftFlow is ExtendedBaseTest {
    ...
    function _setUp() public override {
        MEGA.approve(address(escrow), TOKEN_1);
    ...
    function testSimpleManagedNftFlow() public {
        ...
        // simulate rebases for epoch 0
        deal(address(MEGA), address(distributor), TOKEN_1);
        ...
        assertEq(escrow.supply(), supply);
        assertEq(MEGA.balanceOf(address(lockedManagedReward)), TOKEN_1);
        assertEq(lockedManagedReward.earned(address(MEGA), tokenId), 0);
        ...
        assertEq(lockedManagedReward.earned(address(MEGA), tokenId), TOKEN_1 / 2);
        ...
        uint256 pre = MEGA.balanceOf(address(owner4));
        vm.prank(address(voter));
        bribeVotingReward.getReward(mTokenId, rewards);
        uint256 post = MEGA.balanceOf(address(owner4));
        ...
        MEGA.approve(address(freeManagedReward), TOKEN_1 * 2);
        freeManagedReward.notifyRewardAmount(address(MEGA), ((TOKEN_1 * 2) * 3) / 4);
        vm.stopPrank();
        ...
        assertEq(lockedManagedReward.earned(address(MEGA), tokenId), TOKEN_1 / 2);
        assertEq(freeManagedReward.earned(address(MEGA), tokenId), 0);
        assertEq(lockedManagedReward.earned(address(MEGA), tokenId2), TOKEN_1 / 2);
        assertEq(freeManagedReward.earned(address(MEGA), tokenId2), 0);
        ...
        assertEq(lockedManagedReward.earned(address(MEGA), tokenId), TOKEN_1);
        assertEq(freeManagedReward.earned(address(MEGA), tokenId), ((TOKEN_1 * 2) * 3) / 4 / 2);
        assertEq(lockedManagedReward.earned(address(MEGA), tokenId2), TOKEN_1);
        assertEq(freeManagedReward.earned(address(MEGA), tokenId2), ((TOKEN_1 * 2) * 3) / 4 / 2);
        ...
        skip(1 hours);
        pre = MEGA.balanceOf(address(escrow));
        vm.prank(address(owner2));
        voter.withdrawManaged(tokenId2);
        post = MEGA.balanceOf(address(escrow));
        ...
        assertEq(MEGA.balanceOf(address(lockedManagedReward)), TOKEN_1 * 2);
        ...
        assertEq(lockedManagedReward.earned(address(MEGA), tokenId2), 0);
        assertEq(freeManagedReward.earned(address(MEGA), tokenId2), ((TOKEN_1 * 2) * 3) / 4 / 2);
        ...
        assertEq(lockedManagedReward.earned(address(MEGA), tokenId), 0);
        assertEq(MEGA.balanceOf(address(lockedManagedReward)), 0);
        ...
        assertEq(bribeVotingReward.earned(address(MEGA), tokenId), 749095271054930289);
    ...
    function testTransferManagedNftFlow() public {
        ...
        vm.startPrank(address(owner4));
        MEGA.approve(address(freeManagedReward), TOKEN_1 * 2);
        freeManagedReward.notifyRewardAmount(address(MEGA), TOKEN_1);
        vm.stopPrank();
        ...
        // collect rewards from bribe
        pre = MEGA.balanceOf(address(owner3));
        vm.prank(address(voter));
        bribeVotingReward.getReward(mTokenId, rewards);
        post = MEGA.balanceOf(address(owner3));
        assertEq(post - pre, TOKEN_1 * 2);

        // distribute reward to managed nft depositors
        vm.startPrank(address(owner3));
        MEGA.approve(address(freeManagedReward), TOKEN_1 * 2);
        freeManagedReward.notifyRewardAmount(address(MEGA), TOKEN_1 * 2);
        vm.stopPrank();
        ...
        assertEq(freeManagedReward.earned(address(MEGA), tokenId), TOKEN_1 / 2);
        assertEq(freeManagedReward.earned(address(MEGA), tokenId2), (TOKEN_1 * 5) / 2);
    ...
    function testManagedNftRebaseFlow() public {
        ...
        MEGA.approve(address(escrow), TOKEN_1M);
        ...
        assertGt(MEGA.balanceOf(address(distributor)), 0);
        ...
        assertEq(MEGA.balanceOf(address(lockedManagedReward)), managedRebaseTotal);
        assertEq(lockedManagedReward.earned(address(MEGA), tokenId), 0);
        assertEq(escrow.supply(), supply);

        // epoch 3: claim rebases
        skipToNextEpoch(1);
        assertEq(lockedManagedReward.earned(address(MEGA), tokenId), managedRebaseTotal);
        minter.updatePeriod();
        ...
        assertEq(lockedManagedReward.earned(address(MEGA), tokenId), managedRebaseTotal - rebase);
        assertEq(escrow.supply(), supply);
        ...
        skip(1 hours);
        uint256 pre = MEGA.balanceOf(address(escrow));
        voter.withdrawManaged(tokenId);
        uint256 post = MEGA.balanceOf(address(escrow));
