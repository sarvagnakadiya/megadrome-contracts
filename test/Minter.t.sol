...
contract MinterTest is BaseTest {
    ...
    function testTailEmissionWhenWeeklyEmissionDecaysBelowTailStart() public {
        ...
        assertApproxEqRel(MEGA.balanceOf(address(voter)), 9_059_747 * TOKEN_1, 1e12);
        ...
        minter.updatePeriod();
        assertApproxEqAbs(MEGA.balanceOf(address(voter)), 430_810 * 1e18, TOKEN_1);
    ...
    function testMinterWeeklyDistribute() public {
        ...
        minter.updatePeriod();
        post = MEGA.balanceOf(address(voter));
